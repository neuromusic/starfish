...
from starfish.experiment.builder.orderediterator import join_dimension_ids, ordered_iterator
...
def build_image(
    ...
    """
    dimension_sizes = join_dimension_ids(dimension_order, rounds=rounds, chs=chs, zlayers=zlayers)
